...
In previous work we have considered several different wave function forms that make use of standard fixed nuclei quantum chemistry methods~\cite{Tubman_ECG}. %in order create wave functions for non-adiabatic FN-DMC calculations. 
