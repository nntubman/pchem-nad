...
\begin{abstract}
Simulating non-adiabatic effects with explicit many-body wave function is an open field with many challenges.  %Various algorithms can be applied that capture the phenomenology of non-adiabatic effects beyond the Born-Oppenheimer approximation, however except in very few cases its hard to determine how accurate such calculations are.
